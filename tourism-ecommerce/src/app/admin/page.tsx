            ...
            >
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0H8m8 0v2a2 2 0 01-2 2H10a2 2 0 01-2-2V6m8 0a2 2 0 012 2v6.294c0 .319-.192.608-.49.756a19.532 19.532 0 01-8.02 2.025 19.532 19.532 0 01-8.02-2.025A1.143 1.143 0 013 14.294V8a2 2 0 012-2z"
                />
              </svg>
                ...
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-hostvue-gray mt-1">
                      Create a new tourism service offering
                    </p>
                  </div>
                </div>
                <ServiceForm />
              ...
              <Card className="p-6 border-0 shadow-lg bg-white rounded-xl">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-hostvue-gray mt-1">
                      Manage your current service offerings
                    </p>
                  </div>
                </div>
                <ServicesList />
              ...
              <Card className="p-6 border-0 shadow-lg bg-white rounded-xl">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-hostvue-gray mt-1">
                      Register a new destination or venue
                    </p>
                  </div>
                </div>
                <LocationForm />
              ...
              <Card className="p-6 border-0 shadow-lg bg-white rounded-xl">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-hostvue-gray mt-1">
                      Manage your current destinations
                    </p>
                  </div>
                </div>
                <LocationsList />
              ...
              <Card className="p-6 border-0 shadow-lg bg-white rounded-xl">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-hostvue-gray mt-1">
                      Manage your current categories
                    </p>
                  </div>
                </div>
                <CategoriesList />
